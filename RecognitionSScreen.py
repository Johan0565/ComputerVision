...
def face_detector(img):
    ...
    if len(faces) == 0:  # Если лица не найдены, возвращаем пустой список
        return img, []
...
with mss.mss() as sct:
    ...
    while True:
        ...
        frame = np.array(screenshot)  # Преобразование в массив
        frame = cv2.cvtColor(frame, cv2.COLOR_BGRA2BGR)  # Удаление альфа-канала
